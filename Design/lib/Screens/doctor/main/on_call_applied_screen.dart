...
import 'package:design/Screens/doctor/main/on_call_applied_otp_screen.dart';
...
class OnCallAppliedScreen extends StatefulWidget {
  const OnCallAppliedScreen({Key? key}) : super(key: key);

  @override
  State<OnCallAppliedScreen> createState() => _OnCallAppliedScreenState();
}

class _OnCallAppliedScreenState extends State<OnCallAppliedScreen> {
                    ...
                    child: Column(
                      ...
                      children:   [
                        ...
                        Center(
                          child: InkWell(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => const OnCallAppliedOtpScreen()));
                            },
                            child: Container(
                              height: 53,
                              width: 150,
